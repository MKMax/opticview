...
public final class ObservableGroup<T> implements Disposable {
    ...
    public static final class Builder<U> {
         ...
         */
        @SafeVarargs
        public final Builder<U> withValues (ObservableValue<? extends U>... props) {
         ...
         */
        @SafeVarargs
        public final Builder<U> withGroups (ObservableGroup<? extends U>... groups) {
            instance.addAll (groups);
            return this;
        }

        /**
         * Adds all of the specified listeners using {@link ObservableGroup#addAll(SimpleListener...)}
         *
         * @param listeners The listeners to add to the {@link ObservableGroup}.
         * @return This builder.
         */
        public final Builder<U> withListeners (SimpleListener... listeners) {
            instance.addAll (listeners);
            return this;
        }

        /**
         * Adds all of the specified listeners using {@link ObservableGroup#addAll(ChangeListener...)}
         *
         * @param listeners The listeners to add to the {@link ObservableGroup}.
         * @return This builder.
         */
        @SafeVarargs
        public final Builder<U> withListeners (ChangeListener<? super U>... listeners) {
            instance.addAll (listeners);
            return this;
        }
